...
_ROOT_DEFAULTS = [
	...
	('myTraktLists',    'My Lists', 'myTraktLists',                        'trakt.png',        'userlists.png',    1, 1, 1, 5,  0, 'trakt_credentials', 0, None),
	('myMovies',        '32003', 'mymovieNavigator',                       'mymovies.png',     'mymovies.png',     1, 1, 1, 6,  0, None, 0, None),
	('myTVShows',       '32004', 'mytvNavigator',                          'mytvshows.png',    'mytvshows.png',    1, 1, 1, 7,  0, None, 0, None),
	('youtube',         'YouTube Videos', 'youtube',                       'youtube.png',      'youtube.png',      1, 1, 1, 8,  0, None, 0, None),
	('search',          '32010', 'tools_searchNavigator',                  'search.png',       'search.png',       1, 1, 1, 9,  0, None, 0, None),
	('tools',           '32008', 'tools_toolNavigator',                    'tools.png',        'tools.png',        1, 1, 1, 10, 0, None, 0, None),
	('downloads',       '32009', 'downloadNavigator',                      'downloads.png',    'downloads.png',    1, 1, 1, 11, 0, None, 0, None),
	('favourites',      '40464', 'favouriteNavigator',                     'highly-rated.png', 'highly-rated.png', 1, 1, 1, 12, 0, None, 0, None),
	('premiumServices', 'Premium Services', 'premiumNavigator',            'premium.png',      'premium.png',      1, 1, 1, 13, 0, None, 0, None),
	('changelog',       '32014', 'tools_ShowChangelog&name=Umbrella',      'changelog.png',    'changelog.png',    0, 1, 0, 14, 0, None, 0, None),
	('fullChangelog',   '40589', 'tools_ShowFullChangelog&name=Umbrella',  'changelog.png',    'changelog.png',    0, 1, 0, 15, 0, None, 0, None),
]
